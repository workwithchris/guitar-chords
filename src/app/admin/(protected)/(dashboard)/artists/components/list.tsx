                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {artist.bio && (
                                                        <p className="text-xs text-muted-foreground line-clamp-1 max-w-[250px]">{artist.bio}</p>
                                                    )}
                                                </div>
                                            </div>
                                        </TableCell>
                                        <TableCell className="text-muted-foreground font-mono text-xs">{artist.slug}</TableCell>
                                        <TableCell>
                                            <Switch
